...
if simulate:
    ...
    plt.subplot(221)
    plt.cla()
    plt.pcolor(amplitudes * pi_pulse_amplitude/1e3, nb_of_pulses, I)
    plt.xlabel("Rabi pulse amplitude [mV]")
    plt.ylabel("# of Rabi pulses")
    plt.title("I quadrature [V]")
    plt.subplot(222)
    plt.cla()
    plt.pcolor(amplitudes * pi_pulse_amplitude/1e3, nb_of_pulses, Q)
    plt.xlabel("Rabi pulse amplitude [mV]")
    plt.title("Q quadrature [V]")
    plt.subplot(212)
    plt.cla()
    plt.plot(amplitudes * pi_pulse_amplitude/1e3, np.sum(I, axis=0))
    plt.xlabel("Rabi pulse amplitude [mV]")
